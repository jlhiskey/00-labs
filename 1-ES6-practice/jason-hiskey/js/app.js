...
function displayPics(){
  ...
  console.log(rando);
  // Line 37 threw an error because by switching to let rando has now become a value that belongs to the function displayPics. It that console log had been placed inside of the displayPics function it would have worked.
  console.log(viewed);
